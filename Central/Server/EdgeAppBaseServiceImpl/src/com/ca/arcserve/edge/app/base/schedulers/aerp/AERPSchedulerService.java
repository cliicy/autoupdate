...
public class AERPSchedulerService {
	Logger logger = Logger.getLogger(AERPSchedulerService.class);
	private static AERPSchedulerService INSTANCE = new AERPSchedulerService();

	public static AERPSchedulerService getInstance() {
		return INSTANCE;
	}
