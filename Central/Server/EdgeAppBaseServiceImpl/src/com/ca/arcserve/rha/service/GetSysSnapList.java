 ...
 *         &lt;element name="app_snapshot_type" type="{http://www.w3.org/2001/XMLSchema}unsignedInt"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "get_sys_snap_list")
public class GetSysSnapList {
    ...
    @XmlElement(name = "app_snapshot_type")
    @XmlSchemaType(name = "unsignedInt")
    protected long appSnapshotType;
    ...
    /**
     * Gets the value of the appSnapshotType property.
     * 
     */
    public long getAppSnapshotType() {
        return appSnapshotType;
    }

    /**
     * Sets the value of the appSnapshotType property.
     * 
     */
    public void setAppSnapshotType(long value) {
        this.appSnapshotType = value;
    }
