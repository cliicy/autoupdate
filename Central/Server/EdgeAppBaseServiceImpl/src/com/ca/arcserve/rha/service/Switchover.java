 ...
 *         &lt;element name="run_reverse_scenario" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "switchover")
public class Switchover {
    ...
    @XmlElement(name = "run_reverse_scenario")
    protected boolean runReverseScenario;
    ...
    /**
     * Gets the value of the runReverseScenario property.
     * 
     */
    public boolean isRunReverseScenario() {
        return runReverseScenario;
    }

    /**
     * Sets the value of the runReverseScenario property.
     * 
     */
    public void setRunReverseScenario(boolean value) {
        this.runReverseScenario = value;
    }
