 ...
 *         &lt;element name="replica_index" type="{http://www.w3.org/2001/XMLSchema}unsignedInt"/>
 *         &lt;element name="auto_db_proc" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
public class StartAr {
    ...
    @XmlElement(name = "replica_index")
    @XmlSchemaType(name = "unsignedInt")
    protected long replicaIndex;
    @XmlElement(name = "auto_db_proc")
    protected boolean autoDbProc;
    ...
    /**
     * Gets the value of the replicaIndex property.
     * 
     */
    ...
    /**
     * Sets the value of the replicaIndex property.
     * 
     */
    public void setReplicaIndex(long value) {
        this.replicaIndex = value;
    }

    /**
     * Gets the value of the autoDbProc property.
     * 
     */
    public boolean isAutoDbProc() {
        return autoDbProc;
    }

    /**
     * Sets the value of the autoDbProc property.
     * 
     */
    public void setAutoDbProc(boolean value) {
        this.autoDbProc = value;
    }
