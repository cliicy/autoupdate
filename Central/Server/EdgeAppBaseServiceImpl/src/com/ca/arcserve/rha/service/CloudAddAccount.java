 ...
 *         &lt;element name="account_provider" type="{http://www.w3.org/2001/XMLSchema}unsignedInt"/>
...
@XmlRootElement(name = "cloud_add_account")
public class CloudAddAccount {
    ...
    @XmlElement(name = "account_provider")
    @XmlSchemaType(name = "unsignedInt")
    protected long accountProvider;
    ...
    /**
     * Gets the value of the accountProvider property.
     * 
     */
    ...
    /**
     * Sets the value of the accountProvider property.
     * 
     */
    public void setAccountProvider(long value) {
        this.accountProvider = value;
    }
