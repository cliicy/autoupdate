 ...
 *       &lt;sequence>
 *         &lt;element name="autoconfig_group_dbResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = {
    "autoconfigGroupDbResult",
    "asyncResId",
    "errMessages"
})
@XmlRootElement(name = "autoconfig_group_dbResponse")
public class AutoconfigGroupDbResponse {

    @XmlElement(name = "autoconfig_group_dbResult")
    protected boolean autoconfigGroupDbResult;
    ...
    /**
     * Gets the value of the autoconfigGroupDbResult property.
     * 
     */
    public boolean isAutoconfigGroupDbResult() {
        return autoconfigGroupDbResult;
    }

    /**
     * Sets the value of the autoconfigGroupDbResult property.
     * 
     */
    public void setAutoconfigGroupDbResult(boolean value) {
        this.autoconfigGroupDbResult = value;
    }
