 ...
 *       &lt;sequence>
 *         &lt;element name="cloud_reboot_instanceResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = {
    "cloudRebootInstanceResult",
    "asyncId",
    "errMessages"
})
@XmlRootElement(name = "cloud_reboot_instanceResponse")
public class CloudRebootInstanceResponse {

    @XmlElement(name = "cloud_reboot_instanceResult")
    protected boolean cloudRebootInstanceResult;
    ...
    /**
     * Gets the value of the cloudRebootInstanceResult property.
     * 
     */
    public boolean isCloudRebootInstanceResult() {
        return cloudRebootInstanceResult;
    }

    /**
     * Sets the value of the cloudRebootInstanceResult property.
     * 
     */
    public void setCloudRebootInstanceResult(boolean value) {
        this.cloudRebootInstanceResult = value;
    }
