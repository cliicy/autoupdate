 ...
 *       &lt;sequence>
 *         &lt;element name="verify_group_stateResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = {
    "verifyGroupStateResult",
    "asyncResId",
    "errMessages"
})
@XmlRootElement(name = "verify_group_stateResponse")
public class VerifyGroupStateResponse {

    @XmlElement(name = "verify_group_stateResult")
    protected boolean verifyGroupStateResult;
    ...
    /**
     * Gets the value of the verifyGroupStateResult property.
     * 
     */
    public boolean isVerifyGroupStateResult() {
        return verifyGroupStateResult;
    }

    /**
     * Sets the value of the verifyGroupStateResult property.
     * 
     */
    public void setVerifyGroupStateResult(boolean value) {
        this.verifyGroupStateResult = value;
    }
