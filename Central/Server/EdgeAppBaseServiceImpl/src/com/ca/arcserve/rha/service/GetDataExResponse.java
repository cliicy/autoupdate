 ...
 *       &lt;sequence>
 *         &lt;element name="get_data_exResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "get_data_exResponse")
public class GetDataExResponse {

    @XmlElement(name = "get_data_exResult")
    protected boolean getDataExResult;
    ...
    /**
     * Gets the value of the getDataExResult property.
     * 
     */
    public boolean isGetDataExResult() {
        return getDataExResult;
    }

    /**
     * Sets the value of the getDataExResult property.
     * 
     */
    public void setGetDataExResult(boolean value) {
        this.getDataExResult = value;
    }
