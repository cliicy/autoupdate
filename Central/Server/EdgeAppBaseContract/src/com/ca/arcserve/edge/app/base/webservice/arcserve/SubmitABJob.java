 ...
 *         &lt;element name="strJobScript" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SubmitABJob")
public class SubmitABJob {
    ...
    @XmlElementRef(name = "strJobScript", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> strJobScript;
    ...
    /**
     * Gets the value of the strJobScript property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getStrJobScript() {
        return strJobScript;
    }

    /**
     * Sets the value of the strJobScript property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setStrJobScript(JAXBElement<String> value) {
        this.strJobScript = ((JAXBElement<String> ) value);
    }
