...
static INT G_MAX_PROC_COUNT = 127;
...
VOID ReadIniFile( IN CONST WCHAR * pFile, TINIFile & Ini )
{
	...
	pTempBuffer[0] = 0;
	GetPrivateProfileString(INI_Section_Settings,INI_ServiceName,L"CAStartAppService", pTempBuffer, TEMP_BUFFER_LEN, pFile);
	...
	pTempBuffer[0] = 0;
	GetPrivateProfileString(INI_Section_Settings, INI_WaitPreviousProcessTimeOut, L"300", pTempBuffer, TEMP_BUFFER_LEN, pFile);
