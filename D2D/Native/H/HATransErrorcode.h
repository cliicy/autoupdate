...
#define E_HA_VDDK_HIWORD                    0xA01F
#define IS_HAVDDK_ERROR(err) ((unsigned long)(err >> 16 & 0xFFFF) == E_HA_VDDK_HIWORD)
//
//error code
//
...
//E_HA_VDDK_HIWORD 0xA01F
#define E_HA_VMDKIO_ERROR_FAIL              0xA01F0001
