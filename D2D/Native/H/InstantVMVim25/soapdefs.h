...
#ifdef _USRDLL
#ifdef InstantVMVim25_EXPORTS
#define SOAP_CMAC __declspec(dllexport)
#define VIM25API  __declspec(dllexport)	
#else
#define SOAP_CMAC __declspec(dllimport)
#define VIM25API __declspec(dllimport)
#endif
#else
#define VIM25API
#endif
