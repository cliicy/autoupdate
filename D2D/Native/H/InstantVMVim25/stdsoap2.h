...
SOAP_FMAC1 void VIM25API SOAP_FMAC2 soap_ssl_init(void);
...
#endif
#if defined(VXWORKS) && defined(WM_SECURE_KEY_STORAGE)
SOAP_FMAC1 int VIM25API SOAP_FMAC2 soap_ssl_client_context(struct soap *soap, unsigned short flags, const char *keyfile, const char *keyid, const char *password, const char *cafile, const char *capath, const char *randfile);
#else
SOAP_FMAC1 int VIM25API SOAP_FMAC2 soap_ssl_client_context(struct soap *soap, unsigned short flags, const char *keyfile, const char *password, const char *cafile, const char *capath, const char *randfile);
#endif
...
SOAP_FMAC1 void VIM25API SOAP_FMAC2 soap_done(struct soap*);
SOAP_FMAC1 void SOAP_FMAC2 soap_cleanup(struct soap*);
SOAP_FMAC1 void SOAP_FMAC2 soap_begin(struct soap*);
SOAP_FMAC1 void VIM25API SOAP_FMAC2 soap_end(struct soap*);
SOAP_FMAC1 void VIM25API SOAP_FMAC2 soap_delete(struct soap*, void*);
...
#ifndef WITH_NOSTDLIB
SOAP_FMAC1 void VIM25API SOAP_FMAC2 soap_print_fault(struct soap*, FILE*);
