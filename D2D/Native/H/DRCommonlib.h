...
/*Description
* Get JRE path and class path of a specified module from a configuration file.
* The configuration file is "..\Engine\Configuration\EnvironmentVar.ini" or "..\Management\Configuration\EnvironmentVar.ini"
* or "X:\windows\system32\DR\EnvironmentVar.ini" for BMR
* @ module : the module name 
* @ strJREEnvPath: the JRE environment path
* @ strClassPath: the class path of the specified module
*/
DWORD WINAPI GetJREEnvironmentVariables(const std::string& strModuleName, std::string& strJREEnvPath, std::string& strClassPath);
