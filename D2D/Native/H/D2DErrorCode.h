...
#define D2D_FACILITY_MERGE                        0x900
...
#define D2DCOMM_E_LOCK_CANCELED_BY_USER               D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 52)
#define D2DCOMM_E_CATALOG_JS_NOT_MATCHED_SESSION      D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 53)
#define D2DCOMM_E_UNABLE_FIND_SEPARATE_BKDEST_INFO    D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 54)
#define D2DCOMM_E_NO_ENOUGH_FREE_SPACE_4_OPERATION    D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 55)
#define D2DCOMM_E_JOB_IS_CANCELLED_BY_USER            D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 56)
#define D2DCOMM_E_PASSWORD_IS_INCORRECT               D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 57)
#define D2DCOMM_E_LICERR_NO_BASE_LICENSE              D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 58)
#define D2DCOMM_E_SIGNATURE_IS_INCORRECT              D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 59)   // [3/24/2014 zhahu03] error code 
#define D2DCOMM_E_FILE_PATH_IS_INCORRECT              D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 60)   // [3/24/2014 zhahu03] error code 
#define D2DCOMM_E_DEST_OR_SESS_UNDER_REMOVING         D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 61)
#define D2DCOMM_E_DUPLICATED_OPERATIONS                D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 62) 
#define D2DCOMM_E_MEM_ALLOC_FAILED              D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 63) 
#define D2DCOMM_E_FC_DISABLED                   D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 64) 
#define D2DCOMM_E_FC_NOTSCHEDULED               D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 65) 
#define D2DCOMM_E_FC_VOL_NOT_BACKUP_SRC_VOL     D2DERRCODEGENBYIDX(D2DCOMM_ERROR_CODE_BASE, 66) 