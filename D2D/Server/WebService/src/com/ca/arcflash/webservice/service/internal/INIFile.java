...
public final class INIFile
{
    ...
    /** Variable to denote the successfull load operation. */
    private boolean bIsFileExists = false;
...
public void setbIsFileExists(boolean bIsFileExists) {
		this.bIsFileExists = bIsFileExists;
	}

	public boolean isbIsFileExists() {
