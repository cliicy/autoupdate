...
public class AzureCloudConfigContainer extends LayoutContainer implements ICloudSettings {
...
//	private HashMap<String,String> bucketCache;
	...
	public AzureCloudConfigContainer(String mode, boolean isForEdge)
	{	
		//initialize cache
//		bucketCache = new HashMap<String,String>();
		...
		connectionFieldSet.ensureDebugId("DD66CE98-2BF5-4e90-A3BC-0A84E0F56D43");
...
//		tdCloudConfigField1.setWidth("40%");		
		...
		txtVendorUsername.ensureDebugId("53F79824-D895-4513-B132-F3E503BF3E44");
...
//		txtVendorUsername.setAllowBlank(false);
		...
		txtVendorPassword.ensureDebugId("0DED2947-5818-45ed-9ACD-A729464F632A");
...
//		txtVendorPassword.setAllowBlank(false);
		...
		advSettingsFieldSet.ensureDebugId("E3B756FE-43BA-4f6b-98F2-808AED31D55A");
		...
		if(!this.isForEdge)
		{
			...
			cmbBucket.ensureDebugId("510EE97D-264F-4527-B8AC-3DC1BC39846F");
			...
			btnAddBucket.ensureDebugId("6B35F0CF-C607-4ed5-BE18-55FC8594A97A");
			...
			btnAddBucket.addSelectionListener(new SelectionListener<ButtonEvent>(){
				...
				public void componentSelected(ButtonEvent ce) {
					...
					if(hostName != null)
					{
						...
						msgError.getDialog().getButtonById("928F0778-2A2B-4763-A1A3-7ED556C64A33");
			...
			refreshBuckets.ensureDebugId("41A17760-4DEB-4d1d-A6F0-A68085F1042C");
		...
		tdCloudConfigField2.setHorizontalAlign(HorizontalAlignment.LEFT);*/
			...
			txtBucketName.ensureDebugId("BE6C1324-CBD2-44a7-ACDB-00383A751305");
...
//			lblRefresh.setWidth(400);
		...
		if(validate(false) == true)
		{
			...
			service.getCloudBuckets(getArchiveCloudInfo(),new AsyncCallback<CloudModel[]>() {
				...
				public void onFailure(Throwable caught) {
					...
					msgError.getDialog().getButtonById(Dialog.OK).ensureDebugId("8BEC786F-78F8-447e-AB7C-C1F14AF0378F");
					msgError.show();
	...
	private LayoutContainer defineProxySettingsSection()
	{
		...
		proxyFieldSet.ensureDebugId("AD3BC80A-F123-428b-B4B8-BA5DD2500EFF");
		...
		txtProxyServer.ensureDebugId("05CC1614-BCED-4618-8EE2-09E9977ACAA8");
...
//		txtProxyServer.setAllowBlank(false);
		...
		ProxyPort.ensureDebugId("6BE928C3-0631-458c-81D4-0C08AA28E4EB");
//		ProxyPort.setAllowBlank(false);
		...
		cbProxyRequiresAuth.ensureDebugId("7FE2A888-D28E-4632-9669-E8A7C66E2535");
		...
		txtProxyUsername.ensureDebugId("655FA544-6489-44db-ADF2-8A1DCC310FC2");
...
//		txtProxyUsername.setAllowBlank(false);
		...
		txtProxyPassword.ensureDebugId("BBA99A16-07C2-477c-8048-049246398F6A");
...
//		txtProxyPassword.setAllowBlank(false);
	...
	public ArchiveCloudDestInfoModel save()
	{
		...
		archiveCloudConfigModel.setCloudSubVendorType(new Long(CloudSubVendorType.WindowsAzure.getValue()));
	...
	public ArchiveCloudDestInfoModel getArchiveCloudInfo()
	{
		...
		cloudInfo.setCloudSubVendorType(new Long(CloudSubVendorType.WindowsAzure.getValue()));
...
/*	public String[] filterBuckets(String[] buckets, String mode)
	...
	private void verifyBucketNameWithCloud(String bucketName, final AsyncCallback callback)
	{
		...
		service.validateBucketNameForAzure(bucketName,isForEdge, new AsyncCallback<Long>() {
			...
			public void onFailure(Throwable caught) {
				...
				msgError.setMinWidth(400);
				msgError.setMessage(((BusinessLogicException)caught).getDisplayMessage());
				msgError.getDialog().getButtonById(Dialog.OK).ensureDebugId("F96AF8F8-7FF3-4fc7-84BE-9EA57483DB14");
				msgError.show();
				callback.onSuccess(-1L);
			}
	...
	public void setVendorURL(HashMap<String, CloudVendorInfoModel> providerInfo) {
		...
		{
			if(providerInfo.get(1+"") != null)
			{
				CloudVendorInfoModel model = providerInfo.get(1+"");
	...
	public void showHideFieldsForCloudSubVendor(
		...
		boolean visible = cloudSubVendor == CloudSubVendorType.WindowsAzureCompatible;
