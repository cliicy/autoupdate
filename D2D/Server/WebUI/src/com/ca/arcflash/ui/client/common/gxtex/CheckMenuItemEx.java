...
public class CheckMenuItemEx extends MenuItemEx {
	...
	private String groupStyle = "x-menu-group-item";
	   ...
	   */
	  public CheckMenuItemEx(String html) {
	    this();
	    setHtml(html);
	  }
	  ...
	  protected void onRadioClick(ComponentEvent ce) {
	    if (parentMenu != null) {
	      for (Component item : parentMenu.getItems()) {
	        if (item instanceof CheckMenuItemEx) {
	          CheckMenuItemEx check = (CheckMenuItemEx) item;
