...
/**
 * Since we want to user HighlightedDatePicker, while the DateMenu is a private member of DateField, so 
 * we copy this class and change DatePicker related part of it
 * @author zhawe03
 *
 */
public class HighlightedDateField extends TriggerField<Date> {
	  ...
	  private HighlightedDateMenu menu;
	  ...
	  public HighlightedDatePicker getDatePicker() {
	    if (menu == null) {
	      menu = cretaeHighlightedDateMenu();
	  ...
	  protected void expand() {
	    HighlightedDatePicker picker = getDatePicker();
	    Object v = getValue();
	    Date d = null;
	  ...
	  protected void onRender(Element target, int index) {
	    ...
	    new KeyNav<FieldEvent>(this) {
	      ...
	      public void onDown(FieldEvent fe) {
	    	  HighlightedDateField.this.onDown(fe);
	      }
	  ...
	  public void addSelectedDate(Date d, boolean isInCurrentMonth){
		  this.getDatePicker().addSelectedDate(d, isInCurrentMonth);
	  }

	  //set date value to the date text field and date picker
	  @Override
