...
import com.ca.arcflash.ui.client.homepage.navigation.NavigationCollapsePanel;
...
// This class was copied from BorderLayout, 
// The purpose is to replace CollapsePanel with NavigationCollapsePanel
public class NavigationBorderLayout extends Layout /*BorderLayout*/
{	
	...
	protected CollapsePanel createCollapsePanel(ContentPanel panel, BorderLayoutData data) {
		    ...
		    int size = 50;
		    if(appType == AppType.VCM && data.getRegion() == LayoutRegion.WEST) {
			    ...
			    cp = new NavigationCollapsePanel(panel, data,appType) {
			      protected void onExpandButton(BaseEvent be) {
			        if (isExpanded()) {
			          setExpanded(false);
			        }
	  ...
	  public NavigationBorderLayout(AppType appType) {
		 this();
