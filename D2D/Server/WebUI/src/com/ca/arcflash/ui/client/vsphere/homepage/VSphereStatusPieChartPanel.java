...
public class VSphereStatusPieChartPanel extends LayoutContainer implements IRefreshable{
...
//	.append("</html>").toString();
	...
	public void render(Element target, int index) {
	    ...
	    descriptionText.ensureDebugId("90A3BAD8-5A0D-4040-B09A-ED92936FD3D4");
		...
		service.getVMBackupInforamtionSummary(UIContext.backupVM,new BaseAsyncCallback<BackupInformationSummaryModel>(){
			@Override
